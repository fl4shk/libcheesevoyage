...
case class Gpu2d(
  ...
  val loc = new Area {
    ...
    case class GlobFullLineNumPipe(
      ...
      val rLineNumFracCntPipe1 = (
        Reg(cloneOf(rLineNumFracCnt))
        init(
          fracCntInit
          //0x0
          //-1
        ...
        for (jdx <- 0 until njMyArr.size) {
          njMyArr(jdx)(
            ...
            wrObjSubLineMemArr(
              ...
              wrObjSubLineMemArr(jdx).io.modFrontPayload.head
            )
          )
          if (vivadoDebug) {
            //njMyArr(jdx)(
        ...
        for (jdx <- 0 until njMyArr.size) {
          njMyArr(jdx)(
            ...
            wrObjAffineSubLineMemArr(
              ...
              wrObjAffineSubLineMemArr(jdx).io.modFrontPayload.head
            )
          )
          if (vivadoDebug) {
            //njMyArr(jdx)(
